...
import net.kylejones.recipebook.security.SecurityUtils;
import net.kylejones.recipebook.service.MailService;
...
import net.kylejones.recipebook.web.rest.errors.*;
