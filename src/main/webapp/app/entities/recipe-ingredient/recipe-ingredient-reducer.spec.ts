...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './recipe-ingredient.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECIPEINGREDIENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECIPEINGREDIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECIPEINGREDIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECIPEINGREDIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECIPEINGREDIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECIPEINGREDIENT actions', async () => {
      const expectedActions = [
        {
