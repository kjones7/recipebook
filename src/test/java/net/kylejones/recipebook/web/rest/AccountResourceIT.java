...
import static net.kylejones.recipebook.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import net.kylejones.recipebook.config.Constants;
import net.kylejones.recipebook.domain.PersistentToken;
import net.kylejones.recipebook.domain.User;
import net.kylejones.recipebook.repository.AuthorityRepository;
import net.kylejones.recipebook.repository.PersistentTokenRepository;
import net.kylejones.recipebook.repository.UserRepository;
import net.kylejones.recipebook.security.AuthoritiesConstants;
import net.kylejones.recipebook.service.UserService;
import net.kylejones.recipebook.service.dto.AdminUserDTO;
import net.kylejones.recipebook.service.dto.PasswordChangeDTO;
import net.kylejones.recipebook.service.dto.UserDTO;
import net.kylejones.recipebook.web.rest.vm.KeyAndPasswordVM;
import net.kylejones.recipebook.web.rest.vm.ManagedUserVM;
